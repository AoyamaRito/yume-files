...
- Added `tools/novel-fact-extract.js` and `tools/novel-relation-extract.js` for staged extraction from novel chunks.
- Added `tools/novel-settings-normalize.js` for merging facts and relations into settings collections.
