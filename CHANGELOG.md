...
- Added `tools/novel-source-ingest.js`, a zero-dependency CLI that creates chunk, term, occurrence, and manifest intermediates before emitting source-index, terms-index, and world-facts staging `.yume.js` files.
